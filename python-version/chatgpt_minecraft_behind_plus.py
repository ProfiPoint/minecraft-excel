...
def calculate():
    for squaresA in squares:
        ...
        for point in squaresA[:4]:
            ...
            rotated_vertex = (
                rotated_vertex_1[0] * math.cos(yaw_rad) - rotated_vertex_1[1] * math.sin(yaw_rad),
                rotated_vertex_1[0] * math.sin(yaw_rad) + rotated_vertex_1[1] * math.cos(yaw_rad),
                rotated_vertex_1[2]
            )
            ...
            if int(intersection_point[1]) != 0:
                projected_x = intersection_point[0] / intersection_point[1]
                projected_y = intersection_point[2] / intersection_point[1]
            else:
                intersection_point = (intersection_point[0],1,intersection_point[2])
                projected_x = intersection_point[0] / intersection_point[1]
                projected_y = intersection_point[2] / intersection_point[1]


            # Map the projected coordinates to the screen space
            print(projected_x,intersection_point[0] , intersection_point[1])
